        ...
        <div className="space-y-8">
            <section className="space-y-2">
                ...
                <div className="flex items-center space-x-4 rounded-md border p-4">
                    ...
                    <Switch id="zenzai-enable" checked={value.enable} onCheckedChange={handleZenzaiChange} />
                </div>
                <div className="space-y-4 rounded-md border p-4">
                    ...
                    <Textarea id="zenzai-profile" placeholder="例）山田太郎、数学科の学生。" value={value.profile} disabled={!value.enable} onChange={handleProfileChange} />
                </div>
                <div className="flex items-center space-x-4 rounded-md border p-4">
                    <Cpu />
                    <div className="flex-1 space-y-1">
                        <label htmlFor="zenzai-backend" className="text-sm font-medium leading-none">
                            バックエンド
                        </label>
                        <p className="text-xs text-muted-foreground">
                    ...
                    <Select disabled={!value.enable} value={value.backend} onValueChange={handleBackendChange}>
                        <SelectTrigger id="zenzai-backend" className="w-48">
